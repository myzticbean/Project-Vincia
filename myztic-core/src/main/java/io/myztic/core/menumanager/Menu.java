...
public abstract class Menu implements InventoryHolder {
    ...
    public abstract <T> void setMenuItems(T itemModel);

    public abstract <T> void setMenuItems(List<T> itemsList);

    /**
     * When called, an inventory is created and opened for the player
     */
    public void open() {
        // Needs to run on server MAIN thread
        BukkitUtil.runOnMainThread(MyzticCore.getInst(), () -> {
